...
const Puns = (props) => {
    const [ diplayOptions, setDisplayOptions] = useState(false);
                    ...
                    <Block row card shadow color="white" style={styles.request}>
                        ...
                        <Block flex={0.75} column middle>
                            ...
                            <Text caption >
                                ...
                                <Tooltip popover={<Text>Fire: 10/10</Text>} onLongPress={() => setDisplayOptions(true)} >
                                    <Text> <Icon name="flame" type='octicon' size={16} reverse  />{" "}</Text>
                                </Tooltip>
                                <Tooltip popover={<Text>Hot: 5/10</Text>} onLongPress={() => setDisplayOptions(true)} >
                                    <Text> <Icon name="star" type='octicon' size={16} reverse  />{" "}</Text>
                                </Tooltip>
                                <Icon name="more-vert" size={16} reverse />{" "}
                                
                                {/*{pun.age} • {pun.gender} • {pun.distance}km •{" "} {pun.time}hrs */}
                            </Text>
                        </Block>
                    </Block>
                </TouchableOpacity>
